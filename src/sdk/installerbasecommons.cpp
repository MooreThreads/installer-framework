    ...
    : PackageManagerGui(core, nullptr)
{
    ...
    info_ = new PesLicenceInfo;
    setPage(PackageManagerCore::PesHome, new PesHomePage(core, info_));
    setPage(PackageManagerCore::PesLicence, new PesLicencePage(core, info_));
    setPage(PackageManagerCore::PesInstallation, new PerformInstallationPage(core));
    setPage(PackageManagerCore::PesFinished, new PesFinishPage(core));
    setPage(PackageManagerCore::PesError, new PesErrorPage(core));
    ...
    : PackageManagerGui(core, nullptr)
{
    ...
    setPage(PackageManagerCore::ReadyForInstallation, new PesUninstallHomePage(core));
